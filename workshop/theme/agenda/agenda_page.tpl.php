...
<link rel="stylesheet" type="text/css" href="sites/all/modules/workshop/theme/agenda/css/frontierCalendar/jquery-frontier-cal-1.3.2.css" />

<!-- Include CSS for color picker plugin (Not required for calendar plugin. Used for example.) -->
<link rel="stylesheet" type="text/css" href="sites/all/modules/workshop/theme/agenda/css/colorpicker/colorpicker.css" />

<!-- Include CSS for JQuery UI (Required for calendar plugin.) -->
<link rel="stylesheet" type="text/css" href="sites/all/modules/workshop/theme/agenda/css/jquery-ui/smoothness/jquery-ui-1.8.1.custom.css" />
...
<script type="text/javascript" src="sites/all/modules/workshop/theme/agenda/js/jquery-core/jquery-1.4.2-ie-fix.min.js"></script>

<!-- Include JQuery UI (Required for calendar plugin.) -->
<script type="text/javascript" src="sites/all/modules/workshop/theme/agenda/js/jquery-ui/smoothness/jquery-ui-1.8.1.custom.min.js"></script>

<!-- Include color picker plugin (Not required for calendar plugin. Used for example.) -->
<script type="text/javascript" src="sites/all/modules/workshop/theme/agenda/js/colorpicker/colorpicker.js"></script>

<!-- Include jquery tooltip plugin (Not required for calendar plugin. Used for example.) -->
<script type="text/javascript" src="sites/all/modules/workshop/theme/agenda/js/jquery-qtip-1.0.0-rc3140944/jquery.qtip-1.0.js"></script>
...
-->
<script type="text/javascript" src="sites/all/modules/workshop/theme/agenda/js/lib/jshashtable-2.1.js"></script>

<!-- Include JQuery Frontier Calendar plugin -->
<script type="text/javascript" src="sites/all/modules/workshop/theme/agenda/js/frontierCalendar/jquery-frontier-cal-1.3.2.js"></script>
...
<div  class="ui-widget-header ui-corner-all" style="padding:3px; vertical-align: middle; white-space:nowrap; overflow: hidden;">
	...
	<input type="text" id="iCalSource" size="20" value="sites/all/modules/workshop/theme/agenda/extra/fifa-world-cup-2010.ics"/>
</div>
